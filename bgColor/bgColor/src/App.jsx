...
function App() {
  ...
  return (
   ...
   <button onClick={olive}className='bg-olive px-4 py-1 rounded-lg' style={{backgroundColor:"olive"}}>Olive</button>
  ...
  >Black</button>
   ...
   <button onClick={golden} className='bg-golden px-4 py-1 rounded-lg' style={{backgroundColor:"gold"}}>Golden</button>
   </div>
    </div>
    </div>
  );
